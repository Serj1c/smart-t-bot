...
import (
	...
	"github.com/serjic/yt-search/internal/youtube"
	"github.com/serjic/yt-search/pkg/client/mq"
...
func NewWorker(id int, client mq.Consumer, responseQueue string, producer mq.Producer, messages <-chan mq.Message, logger *logger.Logger, service youtube.Service) Worker {
